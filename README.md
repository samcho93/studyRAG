...
| 왼쪽 | 가운데 | 오른쪽 |
|---|---|---|
| PART → 주차 → 섹션(학생용)/슬라이드(교사용) 목차, 학습 진도, 검색, 학생용/교사용 전환 | 🎓 문서(학습 목표 · 왜 필요한가 · 개념 · ▶ 체험 위젯 · Challenge · 정리)<br>🧑‍🏫 PPT 슬라이드(16:9, 판서 · 타이머 · 화면 가리기 · 전체 화면 · 발표자 창) + 교사 노트, 끝에 부록(강의안 · 정답 · 막히는 지점 · 토론 · 루브릭) | **실행 결과** 터미널 — 위젯 실시간 출력(LIVE), Challenge 코드 ▶ 실행 기록(console.log · console.table) |
...
| 응용 1 | 학과 안내 챗봇 | 멀티턴 대화형 RAG · 질문 재작성 · 되묻기 | 선택 |
| 응용 2 | 조건 검색 | 메타데이터 필터 · 셀프 쿼리 (필터 JSON 검증) | 선택 |
| 응용 3 | RAG 퀴즈 생성기 | 근거 기반 생성 + 자동 검증 · 교사 검토 · 내보내기 | 선택 |
...
weeks/w13~w15/                              RAG 응용 실습 1~3 (PART 5)
